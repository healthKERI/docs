...
<Tabs>
    ...
    <Tab title="windows">
        ```bash Shell
        curl -s -L -o locksmith.dmg https://healthkeri-deployment.sfo3.digitaloceanspaces.com/locksmith/v0.0.1/Windows/Locksmith.zip
        ```

        Or you can download [Locksmith](https://healthkeri-deployment.sfo3.digitaloceanspaces.com/locksmith/v0.0.1/MacOS/Locksmith.zip) directly.
